<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="index.php?act=deleteManyCourse" method="POST" id="deleteAllSelectedForm">
                <div class="tile">
                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="index.php?act=editCourse&courseId=<?=$course['course_id']?>" class="btn btn-primary btn-sm edit" type="button">
