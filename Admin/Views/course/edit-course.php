                    ...
                    <div class="add-product">
                        ...
                        <form class="border p-4 rounded" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-white" id="course_price" name="course_price" value="<?=$courseToEdit['course_price'];?>"/>
                            </div>
                            <div class="mb-3">
                                <label for="course_price_sale" class="form-label">Giá khuyến mãi</label>
                                <input type="number" class="form-control bg-white" id="course_price_sale" name="course_price_sale" value="<?=$courseToEdit['course_price_sale'];?>"/>
                            </div>
                            <div class="mb-3">
                                <label for="course_content" class="form-label">Nội dung khóa học(Những nội dung cách nhau bở dấu ";")</label>
                                <textarea class="form-control bg-white " id="course_content" name="course_content" rows="2"><?=$courseToEdit['course_content'];?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="course_require" class="form-label">Yêu cầu khóa học(Những yêu cầu cách nhau bởi dấu ";")</label>
                                <textarea class="form-control bg-white " id="course_require" name="course_require" rows="2"><?=$courseToEdit['course_require'];?></textarea>
                            </div>
                            <div class="mb-3">
